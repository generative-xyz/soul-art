          ...
          <div className={s.container_inner}>
            <div className={s.loading_inner}>
              ...
              <Text
                ...
                fontWeight={'regular'}
              >
                Step into the land of New Bitcoin City, there is a spirit known
                as GM tokens, they’re the touchstone of hope for a brighter
                future of Bitcoin—the land of freedom.
              </Text>
              <div className={s.loading_icon}>
                <div className={s.loading_icon_inner}>
                  <img
                    src={`${CDN_URL}/ic-loading-dark.svg`}
                    alt="ic-loading"
                  />
                </div>
