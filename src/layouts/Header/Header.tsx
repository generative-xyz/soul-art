...
const Header = ({height, isAnimation, theme}: { height: number; isAnimation?: boolean, theme?: string }) => {
    ...
    return (
        <Wrapper className={classNames(headerStyles.header, theme ? headerStyles[theme] : '')} style={{height}}>
            {
                isAnimation ? <AnimFade>
                    <ContentHader/>
                </AnimFade> : <ContentHader/>
            }
        </Wrapper>
    );
};
